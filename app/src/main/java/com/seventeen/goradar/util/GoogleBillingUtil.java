...
public class GoogleBillingUtil {
    ...
    public String[] subsSKUS = new String[]{"pokeradar_subscription_01"};//订阅ID,必填
    ...
    private static final String BASE_64_ENCODED_PUBLIC_KEY = "";
    ...
    public GoogleBillingUtil build() {
        if (mBillingClient == null) {
            synchronized (mGoogleBillingUtil) {
                Log.d("tt", "BaseApplication.getInstance(): " + BaseApplication.getInstance());
                if (mBillingClient == null) {
                    if (isGooglePlayServicesAvailable(BaseApplication.getInstance())) {
                        builder = BillingClient.newBuilder(BaseApplication.getInstance());
